...
bool is_ignore(USER_DATA *usr, char *name, bool ignoreLevel);
...
bool instr(const char *astr, const char *bstr);
...
#define DBFILE_EN2EN    "dict/en2en.db3"
#define DBFILE_EN2TR    "dict/en2tr.db3"
#define DBFILE_TR2EN    "dict/tr2en.db3"
#define DBFILE_FR2TR    "dict/fr2tr.db3"
#define DBFILE_TR2FR    "dict/tr2fr.db3"
#define DBFILE_TR2TR    "dict/tr2tr.db3"
